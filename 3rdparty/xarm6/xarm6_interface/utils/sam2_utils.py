...
from xarm6_interface import SAM2_CHECKPOINT, SAM2_MODEL_CONFIG, GROUNDING_DINO_CONFIG, GROUNDING_DINO_CHECKPOINT, BOX_THRESHOLD, TEXT_THRESHOLD, DUMP_JSON_RESULTS
...
def grounding_dino_get_bbox(rgb_np, text):
    ...
    image, _ = transform(rgb_image, None)
...
if __name__ == "__main__":
    ...
    text = "black boy jumping."  # VERY important: text queries need to be lowercased + end with a dot
    input_boxes = grounding_dino_get_bbox(rgb_frame, text)
